...
def generate_single(image_id, image_in, label,ours_epoch_1000,
...
<tr>
    ...
    """ % (image_id, image_in, image_in, label, label,ours_epoch_1000,ours_epoch_1000,
...
ours_epoch_1000_path = './train_aachen_24_batch_12_unique_high_res_epoch_1000/color/'
ours_epoch_2000_path = './train_aachen_24_batch_12_unique_high_res_epoch_2000/color/'
ours_epoch_3000_path = './train_aachen_24_batch_12_unique_high_res_epoch_3000/color/'
ours_epoch_4000_path = './train_aachen_24_batch_12_unique_high_res_epoch_4000/color/'
ours_epoch_5000_path = './train_aachen_24_batch_12_unique_high_res_epoch_5000/color/'
...
file_path = './train_aachen_24_batch_12_unique_high_res.html'
f = open(file_path, 'w')
l = os.listdir(path)
s = ''
# for file in l:
...
for file in l:
    ...
    single_html = generate_single(image_id, image_in, label,ours_epoch_1000,
                                  ours_epoch_2000,ours_epoch_3000,ours_epoch_4000,ours_epoch_5000)
    s += single_html
